...
export default function App() {
  ...
  return (
    <div className="h-dvh w-full flex flex-col bg-[#0B0F17] text-[#F8FAFC] font-['Inter',system-ui,sans-serif] overflow-hidden">
      <header className="flex items-center justify-between flex-none px-4 pt-[calc(env(safe-area-inset-top)+12px)] pb-3">
        <div>
      ...
      <div ref={contentRef} className="flex-1 overflow-y-auto scrollable-content px-4">
      ...
      <nav className="flex-none bg-[#0B0F17]/90 backdrop-blur-lg border-t border-white/[0.06] pb-[env(safe-area-inset-bottom)]">
